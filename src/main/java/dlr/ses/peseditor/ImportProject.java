 ...
 * <h1>ImportProject</h1>
 * <p>
 * This class implements Import Project Window for importing PES project created
...
public class ImportProject extends JPanel {
    ...
    public void importProject() {
        ...
        projectLocationField.setText(PESEditor.fileLocation);
        ...
        selectImportProjectLocation.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                fileChooser.setCurrentDirectory(new File(PESEditor.repFslas));
                int result = fileChooser.showOpenDialog(PESEditor.framew);

                if (result == JFileChooser.APPROVE_OPTION) {
                    File selectedFile = fileChooser.getSelectedFile();
                    PESEditor.importFileName = selectedFile.getName();

                    PESEditor.importFileLocation = selectedFile.getParentFile().getAbsolutePath();

                    newRootNameField.setText(PESEditor.importFileLocation);
                }
        ...
        selectProjectLocation.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JFileChooser.APPROVE_OPTION) {
                    File selectedFile = fileChooser.getSelectedFile();
                    PESEditor.fileLocation = selectedFile.getAbsolutePath();
                    projectLocationField.setText(PESEditor.fileLocation);
                }
            }
        });
        ...
        create.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                PESEditor.treePanel.ssdFileVar = new File(
                        PESEditor.fileLocation + "/" + PESEditor.projName + "/" + newProjectName + ".ssdvar");
                PESEditor.treePanel.ssdFileCon = new File(
